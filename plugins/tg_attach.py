...
def attach(update, context):
  if update.message.reply_to_message == None:
    update.message.reply_text("Reply to a media to get an attached Media. For more help watch this video [watch](https://t.me/DX_Botz/170) or join @Dx\_Support"), parse_mode=ParseMode.MARKDOWN)
  else:
